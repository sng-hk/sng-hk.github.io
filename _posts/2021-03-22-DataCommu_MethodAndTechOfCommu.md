...
**2. 지연 왜곡** : 전송매체를 이용해 전달하는 **신호의 속도가 주파수에 따라 차이**가 나는 현상  
...
회선 교환 방식과 다르게 직접 선이 연결되지 않아도 됨.
  


* **비교환회선 방식**  
**단말 장치끼리 직통회선을 연결**하여 사용.  
...
통신 회선 비용이 비싸기때문에 다양한 형태로 위처럼 사용한다.  
**(각 통신망 종류는 각자마다 장단점이 있기 때문에 장단점을 잘 구분하자.)**
